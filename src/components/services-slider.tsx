        ...
        >
          {items.map((item, index) => (
            <SwiperSlide key={index} className="h-full-w-full px-3">
              <div className="group flex aspect-square min-h-[118px] flex-col items-center justify-center gap-2 rounded-xl p-4 text-white shadow-xl duration-200 lg:bg-white lg:text-primary-900 lg:hover:bg-[#DA089F] lg:hover:text-white">
