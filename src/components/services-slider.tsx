        ...
        >
          {items.map((item, index) => (
            <SwiperSlide key={index} className="h-full-w-full px-3">
              <div className="flex aspect-square min-h-[118px] flex-col items-center justify-center gap-2 rounded-xl bg-primary-500 p-4 text-white shadow-xl duration-200 lg:bg-white lg:text-[#f200b3] lg:hover:bg-orange-500 lg:hover:text-white">
